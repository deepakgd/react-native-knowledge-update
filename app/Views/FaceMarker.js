...
export default class FaceMarker extends Component {
    ...
    constructor(props){
        ...
        // get query params data from props
        const { params } = this.props.navigation.state;
        this.imageUrl = params ? params.imageUrl : "../img/face-test.jpeg";
    ...
    render() {
        ...
        return (
            <View >
                <Image source={{uri : this.imageUrl}} style={{width: 300, height: 300, marginHorizontal: 25, marginVertical: 25}} />
