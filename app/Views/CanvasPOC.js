...
export default class CanvasPOC extends Component {
    ...
    render() {
        return (
            ...
            <ScrollView style={styles.examples}>
              <Example sample={require('../img/purple-black-rect.png')}>
                <Canvas ref={this.handleImageData} />
              </Example>
              <Example sample={require('../img/purple-rect.png')}>
                <Canvas ref={this.handlePurpleRect} />
              </Example>
              <Example sample={require('../img/red-circle.png')}>
                <Canvas ref={this.handleRedCircle} />
              </Example>
              <Example sample={require('../img/image-rect.png')}>
                <Canvas ref={this.handleImageRect} />
              </Example>
              <Example sample={require('../img/path.png')}>
                <Canvas ref={this.handlePath} />
              </Example>
              <Example sample={require('../img/gradient.png')}>
                <Canvas ref={this.handleGradient} />
              </Example>
              <Example sample={require('../img/embed-html.png')}>
